INSERT INTO
    item(id, price, name, short_description, description, item_url)
VALUES
    (1, 22.50, 'Pizza Margherita', 'Włoska pizza na cienkim cieście z serem i sosem pomidorowym',
     ...
     'ręcznie przygotowanym sosem pomidorowym i oryginalnym serem mozarella', '/jordon-kaplan-Ks2fH2AAepY-unsplash.jpg'),
    (2, 25.99, 'Pizza Capriciosa', 'Pizza na cienkim cieście z serem, sosem pomidorowym i pieczarkami',
     ...
     'domowego sosu pomidorowego i oryginalnej włoskiej mozarelli znajdziesz tutaj także pieczarki i wyśmienitą sznkę.', '/thomas-tucker-MNtag_eXMKw-unsplash.jpg'),
    (3, 32.99, 'Spaghetti Bolognese', 'Robiona na miejscu pasta z sosem pomidorowym i wołowiną',
     ...
     'lokalnych upraw oraz świeże zioła.', '/homescreenify-sA3wymYqyaI-unsplash.jpg'),
    (4, 18.99, 'Panna Cotta', 'Klasyczny włoski deser o smaku śmietankowym z polewą z truskawek',
     ...
     'w alternatywnej wersji z sosem czekoladowym.', '/adel-grober-eKEBV50VeZs-unsplash.jpg');
